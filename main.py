...
if __name__ == '__main__':
    ...
    for i in range(NUM_CLIENTS):
        clients.append(Client(l2_norm_clip, noise_multiplier, learning_rate, train_data[i], train_labels[i], test_data, test_labels, SEED, CLIENT_LOCAL_UPDATES, percentile))
